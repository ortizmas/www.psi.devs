                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <input id="name" type="text" class="basic-usage form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="Titulo do curso" required autofocus> 
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <input id="url" type="text" class="basic-usage form-control{{ $errors->has('url') ? ' is-invalid' : '' }}" name="url" value="{{ old('url') }}" placeholder="Url do curso" required autofocus> 
                                                @if ($errors->has('url'))
                                                    <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <input id="video" type="text" class="form-control{{ $errors->has('video') ? ' is-invalid' : '' }}" name="video" value="{{ old('video') }}" placeholder="Link do video" required autofocus> 
                                                @if ($errors->has('video'))
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <textarea id="description" name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Resumo...">{{ old('description') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                <input id="link_buy" type="text" class="basic-usage form-control{{ $errors->has('link_buy') ? ' is-invalid' : '' }}" name="link_buy" value="{{ old('link_buy') }}" placeholder="URL de pagamento (PagSeguro)" required autofocus> 
                                                @if ($errors->has('link_buy'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('link_buy') }}</strong>
                                                    </span> 
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="price" type="text" data-affixes-stay="true" data-prefix="R$ " data-thousands="." data-decimal="," class="basic-usage form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ old('price') }}" placeholder="00,00" required autofocus> 
                                        @if ($errors->has('price'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="price_old" type="text" class="basic-usage form-control{{ $errors->has('price_old') ? ' is-invalid' : '' }}" name="price_old" value="{{ old('price_old') }}" placeholder="00.00" required autofocus> 
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="total_hours" type="text" class="basic-usage form-control{{ $errors->has('total_hours') ? ' is-invalid' : '' }}" name="total_hours" value="{{ old('total_hours') }}" placeholder="00:00" required autofocus> 
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="free" name="free" class="form-control{{ $errors->has('free') ? ' is-invalid' : '' }}">
                                            <option value="1" {{ old('free')=='1' ? 'selected' : ''  }}>Curso pago</option>
                                            <option value="0" {{ old('free')=='0' ? 'selected' : ''  }}>Curso free</option>
                                        </select>
                                        @if ($errors->has('free'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="input-group mb-3">
                                        <select id="published" name="published" class="form-control{{ $errors->has('published') ? ' is-invalid' : '' }}">
                                            <option value="1" {{ old('published')=='1' ? 'selected' : ''  }}>Publicar</option>
                                            <option value="0" {{ old('published')=='0' ? 'selected' : ''  }}>Despublicar</option>
                                        </select>
