        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('pages.index') }}" class="btn btn-info btn-sm">Lista de categorias</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input id="title" type="text" class="basic-usage form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('title') }}" placeholder="Nome do menu" required autofocus> 
                                    @if ($errors->has('title'))
                                ...
                                <div class="input-group mb-3">
                                    <input id="permalink" type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" value="{{ old('slug') }}" placeholder="URL da pagina" required autofocus>
                                    @if ($errors->has('slug'))
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="input-group mb-3">
                                    <select id="parent_id" name="parent_id" class="form-control{{ $errors->has('parent_id') ? ' is-invalid' : '' }}">
                                        ...
                                        @foreach ($pagesParents as $value)
                                            <option value="{{ $value->id }}" {{ old('parent_id')=='1' ? 'selected' : ''  }}>{{ $value->title }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {{-- {!! Form::select('section_id', $pagesParents, null, ['class' => 'form-control', 'placeholder' =>'-- Selecione uma Categoria --', 'required']) !!} --}}
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-block btn-flat">Salvar pagina</button>
                                </div>
                            </div>
                        </div>
                    </div>
