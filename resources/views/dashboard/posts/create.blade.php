        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('posts.index') }}" class="btn btn-info btn-sm">Lista de categorias</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body register-card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" name="date_start" class="start-input form-control"/>
                                                <span class="input-group-btn">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" name="date_end" class="end-input form-control"/>
                                                <span class="input-group-btn">
