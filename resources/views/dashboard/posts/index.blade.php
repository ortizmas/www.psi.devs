                  ...
                  <th>Estado</th>
      				...
      				<tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ ( $value->status == 1 ) ? 'Ativo' : 'Desativo' }}</td>
                           <td><a href="{{ route('posts.edit', $value->id) }}" title="Alterar"><i class="fas fa-edit"></i></a></td>
                           <td>
                                <a href="{{ route('posts.destroy', $value->id) }}" class="btn-delete" title="{{ $value->title }}">
