                        ...
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="form-group mb-3">
                                    <textarea name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Resumo...">{{ $post->description }}</textarea>
                                ...
                                <div class="input-group mb-3">
                                    <textarea id="content" name="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" placeholder="Conteudo do post" rows="10">{{ $post->content }}</textarea>
