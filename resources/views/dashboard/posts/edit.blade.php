                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input id="payment_link" type="text" class="form-control{{ $errors->has('payment_link') ? ' is-invalid' : '' }}" name="payment_link" value="{{ old('payment_link', $post->payment_link) }}" placeholder="Url PagSeguro se tiver (opcional)" required autofocus> 
