      			...
      			<table class="table table-striped">
      				...
      				<tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $value->slug }}</td>
                           <td>{{ $value->enabled }}</td>
                           <td><a href="{{ route('categories.edit', $value->id) }}" title="Alterar"><i class="fas fa-edit"></i></a></td>
                           <td>
                                <a href="{{ route('categories.destroy', $value->id) }}" class="btn-delete" title="{{ $value->name }}">
