                        ...
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group mb-3 col-md-6">
                                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email', $trainee->email) }}" placeholder="E-mail" required autofocus> 
                                        @if ($errors->has('email'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    @if ($errors->has('slug', $trainee->slug))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xs-12 col-md-2">
                                        <div class="input-group mb-3">
                                            <input id="age" type="text" class="form-control{{ $errors->has('age') ? ' is-invalid' : '' }}" name="age" value="{{ old('age', $trainee->age) }}" placeholder="Idade" required autofocus> 
                                            @if ($errors->has('age'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-xs-12 col-md-6 text-center">
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="gender" id="sexoYes"  value="F" {{ old('gender', $trainee->gender) == 'F' ? 'checked' : ''}} />
                                          <label class="form-check-label" for="gender"> Femenino</label>
                                      </div>
                                      <div class="form-check form-check-inline pt-2 pb-4">
                                          <input class="form-check-input" type="radio" name="gender" id="sexoNo"  value="M" {{ old('gender', $trainee->gender) == 'M' ? 'checked' : ''}} />
                                    ...
                                    <div class="col-xs-12 col-md-4">
                                        <div class="input-group mb-3">
                                            <select id="marital_status" name="marital_status" class="form-control{{ $errors->has('marital_status') ? ' is-invalid' : '' }}">
                                                ...
                                                <option value="SOLTEIRO" {{ old('marital_status', $trainee->marital_status)=='SOLTEIRO' ? 'selected' : ''  }}>SOLTEIRO</option>
                                                <option value="CASADO" {{ old('marital_status', $trainee->marital_status)=='CASADO' ? 'selected' : ''  }}>CASADO</option>
                                                <option value="SEPARADO" {{ old('marital_status', $trainee->marital_status)=='SEPARADO' ? 'selected' : ''  }}>SEPARADO</option>
                                                <option value="DIVORCIADO" {{ old('marital_status', $trainee->marital_status)=='DIVORCIADO' ? 'selected' : ''  }}>DIVORCIADO</option>
                                                <option value="VIÚVO" {{ old('marital_status', $trainee->marital_status)=='VIÚVO' ? 'selected' : ''  }}>VIÚVO</option>
                                ...
                                <div class="input-group mb-3">
                                    <input id="some_charges" type="text" class="form-control{{ $errors->has('some_charges') ? ' is-invalid' : '' }}" name="some_charges" value="{{ old('some_charges', $trainee->some_charges) }}" placeholder="Função" required autofocus> 
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="customFile">{{ old('image', $trainee->image) }}</label>
                                    </div>
                                    @if ($errors->has('image'))
                                ...
                                <div class="input-group mb-3">
                                    <textarea id="content" name="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" placeholder="Conteudo do post" rows="10">{{ old('content', $trainee->content) }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="input-group mb-3">
                                    <select id="CourseId" name="course_id" class="form-control{{ $errors->has('course_id') ? ' is-invalid' : '' }}">
                                        ...
                                        @foreach ($courses as $value)
                                            <option value="{{ $value->id }}" {{ old('course_id', $trainee->course_id)== $value->id ? 'selected' : ''  }}>{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    <select id="PeriodId" name="period_id" class="form-control{{ $errors->has('period_id') ? ' is-invalid' : '' }}">
                                        ...
                                        @foreach ($periods as $value)
                                            <option value="{{ $value->id }}" {{ old('period_id', $trainee->period_id)== $value->id ? 'selected' : ''  }}>{{ $value->year }}</option>
                                        @endforeach
                                    </select>
                                    <span class="input-group-btn">
                                        <button class="course-modal btn btn-outline-info" type="button" data-toggle="modal" data-target="#modalForm"><i class="fa fa-plus fa-fw"></i></button>
                                ...
                                <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="redirect" id="redirectYes"  value="1" {{ old('redirect', $trainee->redirect ) == 1 ? 'checked' : ''}} />
                                      <label class="form-check-label" for="redirect"> Sim</label>
                                </div>
                                <div class="form-check form-check-inline pt-2 pb-4">
                                      <input class="form-check-input" type="radio" name="redirect" id="redirectNo"  value="0" {{ old('redirect', $trainee->redirect) == 0 ? 'checked' : ''}} />
                                      <label class="form-check-label" for="redirect"> Não</label>

                                </div>

                                <div class="input-group mb-3">
                                    <input id="external_url" type="text" class="form-control{{ $errors->has('external_url') ? ' is-invalid' : '' }}" name="external_url" value="{{ old('external_url', $trainee->external_url ) }}" placeholder="Url externa se tiver (opcional)" required autofocus> 
                                ...
                                <div class="input-group mb-3">
                                    <input id="author" type="text" class="form-control{{ $errors->has('author') ? ' is-invalid' : '' }}" name="author" value="{{ old('author', $trainee->author) }}" placeholder="Autor do cadastro" required autofocus> 
                                ...
                                <div class="input-group mb-3 w-25">
                                    <input id="order" type="text" class="form-control{{ $errors->has('order') ? ' is-invalid' : '' }}" name="order" value="{{ old('order', $trainee->order) }}" placeholder="Ordem" required autofocus> 
                                    @if ($errors->has('order'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="input-group mb-3">
                                    <select id="enabled" name="enabled" class="form-control{{ $errors->has('enabled') ? ' is-invalid' : '' }}">
                                        ...
                                        <option value="1" {{ old('enabled', $trainee->enabled )=='1' ? 'selected' : ''  }}>Ativo</option>
                                        <option value="0" {{ old('enabled', $trainee->enabled )=='0' ? 'selected' : ''  }}>Inativo</option>
                                    </select>
                                ...
                                <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="have_job" id="have_jobYes"  value="1" {{ old('have_job', $trainee->have_job ) == 1 ? 'checked' : ''}} />
                                      <label class="form-check-label" for="have_job"> Sim</label>
                                </div>
                                <div class="form-check form-check-inline pt-2 pb-4">
                                      <input class="form-check-input" type="radio" name="have_job" id="have_jobNo"  value="0" {{ old('have_job', $trainee->have_job ) == 0 ? 'checked' : ''}} />
                                      <label class="form-check-label" for="have_job"> Não</label>

                                </div>

                                <div class="input-group mb-3">
                                    <input id="office" type="text" class="form-control{{ $errors->has('office') ? ' is-invalid' : '' }}" name="office" value="{{ old('office', $trainee->office ) }}" placeholder="Cargo" required autofocus> 
                                ...
                                <div class="input-group mb-3">
                                    <input id="company" type="text" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" value="{{ old('company', $trainee->company ) }}" placeholder="Empresa onde trabalha" required autofocus> 
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-block btn-flat">Alterar trainee</button>
                                </div>
                            </div>
                        </div>
                    </div>
